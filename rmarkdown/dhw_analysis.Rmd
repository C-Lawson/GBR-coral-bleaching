...
```{r, fig.width=11, fig.height=6.5, warning=FALSE, message=FALSE}
...
-   Total number of reefs exposed to >4DHW in each of the seven previous mass bleaching events (R2 = 0.83): 
