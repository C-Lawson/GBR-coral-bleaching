...
```{r, fig.width=7, fig.height=9, cache=TRUE, warning=FALSE, message=FALSE}
...
```{r, fig.width=11, fig.height=9, cache=TRUE, warning=FALSE, message=FALSE}
...
```{r, fig.width=7, fig.height=6, cache=TRUE, warning=FALSE, message=FALSE}
library(sf)
library(ggplot2)
library(tidyverse)
...
```{r, fig.width=7, fig.height=5, cache=TRUE, warning=FALSE, message=FALSE}
...
```{r, fig.width=5, fig.height=4, cache=TRUE, warning=FALSE, message=FALSE}
gbr_shape_dhw |>
  as.data.frame() |>
  dplyr::select(-geometry, -id, -gbr_name) |>
  pivot_longer(-c(reef_id), names_to="year", values_to="dhw_max") |>
...
```{r, fig.width=11, fig.height=3.5, cache=TRUE, warning=FALSE, message=FALSE}
...
```{r, fig.width=9, fig.height=4.5, cache=TRUE, warning=FALSE, message=FALSE}
...
```{r, fig.width=9, fig.height=5, cache=TRUE, warning=FALSE, message=FALSE}
...
```{r gam, fig.width=7, fig.height=5, cache=TRUE, warning=FALSE, message=FALSE}
library(tidyverse)
library(sf)
library(ggplot2)
library(plotly)
