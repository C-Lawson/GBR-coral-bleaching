...
### b) Frequency of DHW \> 4 exposure (1998 - 2024) 
...
ggplot() + theme_bw() +
  geom_point(aes(year, proportion, fill=proportion), shape=21, size=3.5, 
             show.legend=FALSE) +
  geom_text(aes(year, proportion, label=count), nudge_y=3, nudge_x=0, size=3.5) +
  scale_x_continuous(breaks=seq(1996, 2026,2), limits=c(1996, 2026)) + 
  scale_y_continuous(breaks=seq(0, 100, 20), limits=c(0, 100)) + 
  xlab("\nMass bleaching event Year") + ylab("Number of reefs impacted by >4DHW") +
  scale_fill_distiller(palette = "Reds", direction = 1, limits=c(0,100)) 

```

### c) 1998 - 2024 mass coral bleaching events
...
### b) Increasing intensity of DHW through time
