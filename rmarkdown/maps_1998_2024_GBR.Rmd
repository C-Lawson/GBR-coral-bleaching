...
For clearer spatial comparisons between the past 7 mass coral bleaching events, the interactive approach can be used to synchronise spatial maps of DHW among reefs:
...
gbr_shape_dhw_long <- gbr_shape_dhw2 %>%
...
#tm_basemap("Esri.WorldImagery") +
  tm_shape(gbr_shape_dhw_long |> filter(year %in% c("1998","2002","2012",
                                                    "2016","2017","2020",
                                                    "2022","2024"))) + 
  tm_polygons(col="dhw_max", palette="-RdBu", breaks=seq(0,20,1), alpha=0.8, legend.show=FALSE) +
