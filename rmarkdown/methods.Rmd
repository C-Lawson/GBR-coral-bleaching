...
tm_shape(gbr_shape |> filter(str_detect(id, "99"))) + tm_fill("red") 
...
b <- tm_shape(gbr_shape_dhw |> filter(gbr_name=="Heron Reef") |> mutate(dhw_max_2016=as.numeric(dhw_max_2016))) + 
  tm_polygons(col="dhw_max_2016", title="yearly maximum DHW (2016)", palette="-RdBu", breaks= seq(1:10), alpha=0.8) +
